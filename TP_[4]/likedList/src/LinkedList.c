...
/** \brief Permite obtener el elemento
 * \param this LinkedList* Puntero a la lista
    	...
    	if(pNodeRemove != NULL) {
    		...
    		if(index == 0) {
    			...
    			if(pAuxNode != NULL) {
    				...
    				pAuxNode->pNextNode = pNodeRemove->pNextNode;
    			}
    		}
			this->size--;
			free(pNodeRemove);
...
LinkedList* ll_subList(LinkedList* this,int from,int to)
{
    ...
    if(this != NULL && from >= 0 && from < ll_len(this) && to > from && to <= ll_len(this)) {
    	...
    	if((subList = ll_newLinkedList()) != NULL) {
...
int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*), int order)
{
    ...
    int estaOrdenado;
    int len;
    void* auxElement_1 = NULL;
    void* auxElement_2 = NULL;
    ...
    if(this != NULL && (order == 0 || order == 1) && pFunc != NULL) {
    	...
    	do {
			...
			len --;
			for (int i = 0; i < len; i++) {
				auxElement_1 = ll_get (this, i);//obtengo una dir de memoria
				auxElement_2 = ll_get (this, i+1);//obtengo otra dir de memoria

				if ((order == 1 && pFunc(auxElement_1, auxElement_2) > 0) || (order == 0 && pFunc(auxElement_1, auxElement_2) < 0)) {
					ll_set(this, i, auxElement_2);//le pasa el elemento que quiero que ponga en una posicion determinada
					ll_set(this, i+1, auxElement_1);
					estaOrdenado = 0;
				}
